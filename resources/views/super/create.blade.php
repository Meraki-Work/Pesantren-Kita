...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted mt-1">Tambahkan user baru ke sistem</p>
        </div>
        <a href="{{ route('super.index') }}" class="btn btn-secondary">
        ...
        <div class="card-body">
            <form action="{{ route('super.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            <label class="form-label">Pondok Pesantren <span class="text-danger">*</span></label>
                            <select name="id_ponpes" class="form-select @error('id_ponpes') is-invalid @enderror" required>
                                <option value="">Pilih Pondok Pesantren</option>
                                @foreach($ponpesList as $ponpes)
                                    <option value="{{ $ponpes->id_ponpes }}" {{ old('id_ponpes') == $ponpes->id_ponpes ? 'selected' : '' }}>
                                        {{ $ponpes->nama_ponpes }}
                                    </option>
                                @endforeach
                            </select>
