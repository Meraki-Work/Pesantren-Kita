...
<div class="px-4 py-6">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-800">
                <i class="fas fa-plus-circle mr-2 text-green-600"></i>Tambah Paket Langganan
            </h1>
            <p class="text-gray-500 mt-1">Buat paket langganan baru</p>
        </div>
    ...
    <div class="bg-white rounded-lg shadow-md">
        <form action="{{ route('super.plan.store') }}" method="POST">
            @csrf
            <div class="p-6 space-y-6">
                <!-- Nama Paket -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">Nama Paket <span class="text-red-500">*</span></label>
                    <input type="text" name="name" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 @error('name') border-red-500 @enderror" value="{{ old('name') }}" required>
                    @error('name')
                ...
                <div>
                    ...
                    <textarea name="description" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 @error('description') border-red-500 @enderror" rows="4">{{ old('description') }}</textarea>
                    @error('description')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="number" name="price_month" class="w-full pl-10 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 @error('price_month') border-red-500 @enderror" value="{{ old('price_month', 0) }}" required>
                        </div>
                        @error('price_month')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <span class="absolute left-3 top-2 text-gray-500">Rp</span>
                            <input type="number" name="price_year" class="w-full pl-10 border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500 @error('price_year') border-red-500 @enderror" value="{{ old('price_year', 0) }}" required>
                        </div>
                        @error('price_year')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="bg-gray-50 rounded-lg p-4 space-y-3">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <div>
                                ...
                                <input type="number" name="limits[max_users]" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('limits.max_users', -1) }}" placeholder="-1 untuk unlimited">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-600 mb-1">Max Santri</label>
                                <input type="number" name="limits[max_santri]" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('limits.max_santri', -1) }}" placeholder="-1 untuk unlimited">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-600 mb-1">Max Inventaris</label>
                                <input type="number" name="limits[max_inventaris]" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('limits.max_inventaris', -1) }}" placeholder="-1 untuk unlimited">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-600 mb-1">Max Laundry</label>
                                <input type="number" name="limits[max_laundry]" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('limits.max_laundry', -1) }}" placeholder="-1 untuk unlimited">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-600 mb-1">Max Notulen</label>
                                <input type="number" name="limits[max_notulen]" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('limits.max_notulen', -1) }}" placeholder="-1 untuk unlimited">
                            </div>
                            <div>
                                <label class="block text-xs text-gray-600 mb-1">Storage (MB)</label>
                                <input type="number" name="limits[storage_mb]" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500" value="{{ old('limits.storage_mb', 100) }}" placeholder="100">
                            </div>
                        </div>
                    </div>
