...
<body>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <h5 class="text-primary"><i class="fas fa-address-card me-2"></i>Identitas</h5>
                                ...
                                <div class="col-md-6 mb-3">
                                    <h5 class="text-primary"><i class="fas fa-chart-bar me-2"></i>Statistik</h5>
                                    <ul class="list-unstyled">
    ...
    <section id="visi-misi" class="section-padding">
        <div class="container">
            <h2 class="section-title">Visi & Misi {{ $ponpes->nama_ponpes }}</h2>
            ...
            <div class="visi-misi-section">
                    ...
                    <div class="col-lg-6 mb-4">
                        <div class="visi-card">
                            ...
                            @if($visions->count() > 0)
                                ...
                                <div class="mb-4">
                                    @if($visi->title)
                                    <h4 class="text-primary mb-3">{{ $visi->title }}</h4>
                                    @endif
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted">Informasi visi pesantren sedang dalam proses penyusunan</p>
                                </div>
                            @endif
                        </div>
                    </div>
                        ...
                        <div class="misi-card">
                                ...
                                <div class="misi-list">
                                    ...
                                    <div class="misi-item">
                                        <div class="d-flex align-items-start">
                                            <span class="misi-item-number">{{ $loop->iteration }}</span>
                                            <div>
                                                @if($misi->title)
                                                <h5 class="mb-2 text-dark">{{ $misi->title }}</h5>
                                                @endif
                                                
                                                @if($misi->description)
                                                <p class="mb-0">{{ $misi->description }}</p>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                            ...
                            @else
                                <div class="text-center py-4">
                                    ...
                                    <p class="text-muted">Informasi misi pesantren sedang dalam proses penyusunan</p>
                                </div>
                            @endif
                        </div>
                    </div>
                ...
                <!-- Informasi tambahan tentang visi misi -->
                <div class="row mt-5">
                    <div class="col-lg-12">
                        <div class="alert alert-info">
                            <div class="d-flex">
                                ...
                                <div>
                                    <h5 class="alert-heading mb-2">Mengapa Visi & Misi Penting?</h5>
                                    <p class="mb-0">Visi dan misi {{ $ponpes->nama_ponpes }} menjadi pedoman dalam setiap kegiatan pendidikan dan pengajaran, memastikan setiap langkah yang diambil selaras dengan tujuan utama mencetak generasi islami yang berakhlak mulia.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-5 col-md-6 mb-4">
                    <div class="profile-card">
                        <div class="text-center">
                            ...
                            <h3 class="fw-bold mt-3">{{ $founder->title }}</h3>
                            <p class="text-primary fw-bold mb-3">{{ $founder->position ?? 'Pendiri / Founder' }}</p>
                ...
                <div class="col-lg-5 col-md-6 mb-4">
                    <div class="profile-card">
                        <div class="text-center">
                            ...
                            <h3 class="fw-bold mt-3">{{ $leader->title }}</h3>
                            <p class="text-primary fw-bold mb-3">{{ $leader->position ?? 'Kepala Pesantren' }}</p>
    ...
    <section id="gallery" class="section-padding">
        <div class="container">
            ...
            <p class="text-center text-muted mb-5">Momen-momen berharga di {{ $ponpes->nama_ponpes }}</p>
            
            <!-- Gallery akan ditampilkan di sini -->
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="bg-white p-5 rounded-lg shadow-soft">
                        ...
                        <p class="text-muted">Foto-foto kegiatan pesantren sedang dalam proses pengumpulan</p>
                    </div>
                </div>
            </div>
        </div>
