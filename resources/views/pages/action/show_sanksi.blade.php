        ...
        <div class="bg-white rounded-lg shadow-md p-6 max-w-4xl mx-auto">
            ...
            <div class="flex justify-between items-center mb-6">
                ...
                <div class="flex space-x-2">
                    <!-- PERBAIKAN: 'sanksi.edit' bukan 'sangksi.edit' -->
                    <a href="{{ route('sanksi.edit', $sanksi->id_sanksi) }}" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                        </svg>
                        Edit
                    </a>
                    <!-- PERBAIKAN: 'sanksi.index' bukan 'sangksi' -->
                    <a href="{{ route('sanksi.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white px-4 py-2 rounded-lg flex items-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="md:col-span-2 bg-gray-50 p-4 rounded-lg">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <p class="text-gray-800">{{ $sanksi->ponpes->nama_ponpes ?? 'Tidak diketahui' }}</p>
                        </div>
                        <div>
            ...
            <div class="flex justify-end space-x-4 mt-8 pt-6 border-t border-gray-200">
                <!-- PERBAIKAN: 'sanksi.destroy' bukan 'sangksi.destroy' -->
