        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 my-6">
            <div class="box-bg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-2xl font-bold">{{ $kategories->total() }}</p>
            ...
            <div class="box-bg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-2xl font-bold">{{ $kategories->currentPage() }}</p>
                        <p class="text-sm font-medium">Halaman Saat Ini</p>
                    </div>
                </div>
            </div>
            ...
            <div class="box-bg p-4">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-2xl font-bold">{{ $kategories->perPage() }}</p>
            ...
            <div class="bg-gray-50 px-6 py-4 border-t border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="text-sm text-gray-700">
                        Menampilkan
                        <span class="font-medium">{{ $kategories->firstItem() }}</span>
                        sampai
                        <span class="font-medium">{{ $kategories->lastItem() }}</span>
                        dari
                        <span class="font-medium">{{ $kategories->total() }}</span>
                        hasil
                    </div>
                    <div class="flex space-x-2">
                        {{ $kategories->links() }}
