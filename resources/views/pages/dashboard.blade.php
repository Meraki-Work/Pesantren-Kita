...
@section('content')
    ...
    <div class="flex bg-gray-100">
                ...
                <div class="flex justify-between box-bg col-span-3 row-span-3 col-start-1 px-6 py-3 rounded-lg relative overflow-hidden"
                    ...
                    <div>
                        ...
                        <div class="flex space-x-4 mt-9">
                            <button
                                class="btn-absen w-full h-8 px-5 bg-[#2ECC71] text-white text-sm font-semibold rounded-lg hover:bg-green-600 transition inline-flex items-center justify-center"
                                    ...
                                    if (data.success && data.data.length > 0) {
                                        data.data.forEach(item => {
                                            ...
                                            const statusColor =
                                                ...
                                                item.status === 'Cuti' ? 'border-yellow-500' :
                                                'border-red-500';
        ...
        `;
                            ...
                            buttons.forEach(btn => {
                                btn.addEventListener('click', async () => {
                                    ...
                                    // Jika Izin / Cuti butuh keterangan
            ...
            <div style="text-align: center; margin: 0 auto;">
                <textarea 
                    ...
                    placeholder="Tuliskan keterangan ${status.toLowerCase()}..."
                    rows="8"
                    style="
                        resize: none; 
                        padding: 20px; 
        ...
        `,
                                            ...
                                            didOpen: () => {
                                                setTimeout(() => {
                                                    const textarea = Swal.getPopup()
                                                        .querySelector('#swal-input');
                                                    textarea.focus();
                                                    textarea.style.textAlign = 'center';

                                                    // Nonaktifkan semua scroll
                                                    Swal.getPopup().style.overflow =
                                                        'hidden';
                                                    document.body.style.overflow = 'hidden';

                                                    // Handle scroll dalam textarea (jika perlu)
                                                    textarea.addEventListener('keydown',
                                                        function(e) {
                                                            if (e.key === 'Enter') {
                                                                // Biarkan enter untuk baris baru
                                                            }
                                                        });
                                                }, 100);
                                            },
                                            willClose: () => {
                                                // Kembalikan scroll body saat modal ditutup
            ...
            <div style="text-align: center; padding: 10px 0;">
                <p style="margin-bottom: 15px; color: #374151; font-size: 16px;">Keterangan:</p>
                <div style="
                ...
                ">
                    <p style="margin: 0; color: #4b5563; font-size: 14px; line-height: 1.5; word-wrap: break-word;">${keterangan}</p>
                </div>
            </div>
        `,
                                            icon: 'question',
                    ...
                    <div class="bg-opacity-90 p-2">
                        ...
                        <div class="pt-4">
                            ...
                            <div class="flex justify-end -mt-2">
                                <a href="{{ route('dashboard.absensi.riwayat') }}" class="flex items-center">
                                    Selengkapnya
