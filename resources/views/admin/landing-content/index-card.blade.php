                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 mb-6">
                    ...
                    <div class="p-6">
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <!-- Filter Pesantren -->
                            {{-- di file: resources/views/admin/landing-content/index-card.blade.php --}}
                            ...
                            <div>
                                ...
                                <div class="w-full rounded-md border-gray-300 bg-gray-50 p-2 text-sm">
                                    {{ Auth::user()->ponpes->nama_ponpes ?? 'Pesantren Anda' }}
                                </div>
                            </div>
                            @endif
