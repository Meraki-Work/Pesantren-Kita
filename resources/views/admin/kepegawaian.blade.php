...
<div class="grid grid-cols-4 gap-6 mb-10">
    ...
    <div class="flex items-center border border-gray-300 rounded-lg px-5 py-4 bg-white shadow-sm">
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-green-700" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
    ...
    {{-- Card Tambah Pegawai --}}
    <button class="flex items-center justify-center border border-gray-300 rounded-lg px-5 py-4 bg-white shadow-sm hover:bg-gray-50 transition">
